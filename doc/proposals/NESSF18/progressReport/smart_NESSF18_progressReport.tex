...
%	\doublespacing
	...
	\section{Introduction}
		...
		As stated in the NESSF17 proposal, \MOSES\ and \ESIS\ image in a limited number of diffraction orders/angles (only 3 to 6) \citep{kankel1}, making the process of spectrally-resolving their data is an ill-posed inversion problem.
